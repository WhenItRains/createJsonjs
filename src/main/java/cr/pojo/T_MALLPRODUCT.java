...
public class T_MALLPRODUCT {
	...
	public T_MALLPRODUCT() {
		super();
		// TODO Auto-generated constructor stub
	}
	public T_MALLPRODUCT(int id, String shp_mch, String shp_tp, int flbh1, int flbh2, int pp_id, String chjshj,
			String shp_msh) {
		super();
		this.id = id;
	...
	public String toString() {
		return "T_MALLPRODUCT [id=" + id + ", shp_mch=" + shp_mch + ", shp_tp=" + shp_tp + ", flbh1=" + flbh1
